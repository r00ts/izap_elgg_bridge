...
<?php
	...
	if (is_plugin_enabled('embed')){
		...
		$termslink = "<a href=\"javascript: void(0)\" onclick=\"window.open('".$CONFIG->wwwroot."mod/market/terms.php', '".elgg_echo('market:terms:title')."', 'width=650, height=350'); 	return false;\">".elgg_echo('market:terms:title')."</a>";
	}

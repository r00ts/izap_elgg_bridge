...
function group_menus_izap_contest() {
  ...
  if ($pageowner instanceof ElggGroup && (elgg_get_context() == 'groups' || elgg_get_context() == GLOBAL_IZAP_CONTEST_QUIZ_PAGEHANDLER || elgg_get_context() == GLOBAL_IZAP_CONTEST_CHALLENGE_PAGEHANDLER) && ($pageowner->izapchallenge_enable == 'yes' || empty($pageowner->izapchallenge_enable))) {

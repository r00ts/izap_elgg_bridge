...
$title .= "<a href='" . $vars["url"] . "wicategory/forms/save/wijobskillcategory/" . $vars['entity']->guid  . "' class='categories-popup'><span class='elgg-icon elgg-icon-settings-alt' title='" . elgg_echo("edit") . "'></span></a>";

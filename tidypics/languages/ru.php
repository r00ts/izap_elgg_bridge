...
$russian = array(
		...
		//actions
			...
			'album:addpix' => "Добавить Фото в Альбом",
			'album:edit' => "Редактировать Альбом",
			'album:delete' => "Стереть Альбом",
			'image:edit' => "Редактировать Фото",
			'image:delete' => "Стереть Фото",
			'image:download' => "Скачать Фото",
		...
		//forms
			...
			'album:cover:yes' => "Да",
			'image:access:note' => "(уровень доступа как и у основного Альбома)",
			
		//views
			'image:total' => "Всего Фото:",
			'image:by' => "Фото добавлено:",
			'album:by' => "Альбом принадлежит:",
			'album:created:on' => "Создан:",
			'image:none' => "Пока Фото не добавлено",
			'image:back' => "Назад",
			'image:next' => "Вперед",
		...
		//  river
			...
			'image:river:item' => "фото",
			'image:river:annotate' => "комментариы к Фото",
		...
		//  Status messages
			...
			'images:saved' => "Все Фото успешно сохранены.",
			'image:deleted' => "Ваша Фотография стерта.",			
			'image:delete:confirm' => "Вы уверены, что хотите стереть это Фото?",
			'images:edited' => "Ваши Фото успешно обновленны.",
			...
			'tidypics:status:processing' => "Подождите пока мы загружаем фото....",
				
		//Error messages
			'image:none' => "На данный момент никаких фото не обнаружено.",
			'image:uploadfailed' => "Файлы не загружены:",
			'image:deletefailed' => "В данный момент это Фо стереть невозможно.",
			'image:downloadfailed' => "На данный момент это фото просмотреть невозможно.",
			'image:notimage' => "Допускаются только фото формата jpeg, gif, или png разрешенного размера.",

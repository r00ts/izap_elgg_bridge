<?php 
	...
	if($settings->tokbox_api_server != "api.tokbox.com"){
		$api_server_options = "<option value='staging.tokbox.com' selected='selected'>" . elgg_echo("videochat:settings:tokbox:api_server:sandbox") . "</option>\n";
		$api_server_options .= "<option value='api.opentalk.com'>" . elgg_echo("videochat:settings:tokbox:api_server:production") . "</option>\n";
	} else {
		$api_server_options = "<option value='staging.tokbox.com'>" . elgg_echo("videochat:settings:tokbox:api_server:sandbox") . "</option>\n";
		$api_server_options .= "<option value='api.opentalk.com' selected='selected'>" . elgg_echo("videochat:settings:tokbox:api_server:production") . "</option>\n";
	}

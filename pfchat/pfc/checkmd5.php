...
";
if (md5(file_get_contents("./themes/default/pfchat.js.tpl.php")) == "e3e083e587a98f7fb111aac34201cebf")
  $files_ok[] = "<span style=\"color:#3A3\">ok - ./themes/default/pfchat.js.tpl.php</span>
";
else
  $files_ko[] = "<span style=\"color:#F33\">corrupted - ./themes/default/pfchat.js.tpl.php (please replace this file by a correct one)</span>
";
...
";
if (md5(file_get_contents("./themes/default/pfchat.html.tpl.php")) == "7f842197b18a205deefca9c1f0c90cc9")
  $files_ok[] = "<span style=\"color:#3A3\">ok - ./themes/default/pfchat.html.tpl.php</span>
";
else
  $files_ko[] = "<span style=\"color:#F33\">corrupted - ./themes/default/pfchat.html.tpl.php (please replace this file by a correct one)</span>
";
...
";
if (md5(file_get_contents("./demo/demo31_show_who_is_online-pfchat.php")) == "07225259dc282974d36cb633647b4c4a")
  $files_ok[] = "<span style=\"color:#3A3\">ok - ./demo/demo31_show_who_is_online-pfchat.php</span>
";
else
  $files_ko[] = "<span style=\"color:#F33\">corrupted - ./demo/demo31_show_who_is_online-pfchat.php (please replace this file by a correct one)</span>
";
...
";
if (md5(file_get_contents("./demo/demo32_show_last_messages-pfchat.php")) == "49e651b89129264c33335b6765b40286")
  $files_ok[] = "<span style=\"color:#3A3\">ok - ./demo/demo32_show_last_messages-pfchat.php</span>
";
else
  $files_ko[] = "<span style=\"color:#F33\">corrupted - ./demo/demo32_show_last_messages-pfchat.php (please replace this file by a correct one)</span>
";

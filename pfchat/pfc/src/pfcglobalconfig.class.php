...
class pfcGlobalConfig
{
  ...
  /**
   * <p>This is the only mandatory parameter used to identify the pfchat server.
  ...
  /**
   * <p>Used to translate the pfchat text and messages. Accepted values are the <code>i18n/</code> sub directories names.
   * (By default, this is the local server language.)</p>
   */
  var $language = '';

  /**
   * <p>Set a sepcific encoding for pfchat labels.
   * This is really useful when the Web page embedding the pfchat is not UTF-8 encoded.
   * This parameter should be the same as the pfchat web page.
  ...
  /**
   * <p>Used to change the pfchat title that is visible just above the messages list.
   * (Default value: "My pfchat")</p>
   */
  var $title = '';  
  ...
  /**
   * <p>This array contains the nicknames list you want to initiate a private message at pfchat loading.
   ...
   * This parameter will be dynamically changed depending on the pfchat activity, see refresh_delay_steps
   ...
   * More the pfchat is active, more the refresh_delay is low, that means more the pfchat is responsive.
   ...
   * A user is inactive only if s/he closed his/her pfchat window. A user with an open pfchat window
   ...
   * Attention: 'checktimeout' and 'checknickchange' proxies should not be disabled or the pfchat will not work anymore.
  ...
  /**
   * <p>A custom proxies path. Used to easily plugin your own proxy to the pfchat without modifying the code.
   ...
   * The pfchat uses commands to communicate between client and server.
   ...
   * This is what you see when you reload the pfchat.
  ...
  /**
   * <p>Setting this to true will give the focus to the input text box when connecting to the pfchat.
   * It can be useful not to touch the focus when integrating the pfchat into an existing website
  ...
  /**
   * <p>Setting this to false will oblige user to click on the connect button if s/he wants to pfchat.
   * (Default value: true - a connection to the pfchat is automaticaly performed)</p>
   */
  var $connect_at_startup = true;

  /**
   * <p>Setting it to true will start the pfchat minimized.
   * (Default value: false)</p>
   */
  var $start_minimized = false;

  /**
   * <p>Height of the pfchat area.
  ...
  /**
   * <p>Setting it to false will start the pfchat without sound notifications.
   * (Default value: true)</p>
   */
  ...
  /**
   * <p>Setting it to true will shorten long URLs entered by users in the pfchat area.
   * (Default value: true)</p>
   */
  var $short_url = true;
   ...
   * More the ping is low, faster the pfchat is responding.
   * (Default value: true)</p>
   */
  ...
  /**
   * <p>This is the list of colors that will be used to automaticaly and randomly colorize the nicknames in the pfchat.
  ...
  /**
   * <p>This parameter specifies which theme the pfchat will use.
   * A theme is a package that makes it possible to completly change the pfchat appearance (CSS) and the pfchat dynamics (JS)
  ...
  /**
   * <p>Used to specify the pfchat container (pfchat database).
   ...
   * Very useful when the pfchat (client) script is resource consuming (ex: forum or portal pfchat integration).
   ...
   * (Default value: '' - means this parameter is automatically calculated)</p>
   */
  var $server_script_url = 'mod/pfchat/pfc/index.php';

  /**
   * <p>Used to specify the script path which first displays the pfchat.
  ...
  /**
   * <p>Used to store private data like cache, logs and pfchat history.
   * Tip: you can optimize your pfchat performances,
   ...
   */
  var $data_public_url = 'mod/pfchat/pfc/data/public';
  ...
  /**
   * <p>When debug is true, some traces will be shown on the pfchat clients
   * (Default value: false)</p>
   */
  var $debug = false;

  /**
   * <p>Can be used to setup the pfchat time zone.
   * It is the difference in seconds between pfchat clock and server clock.
   * (Default value: 0)</p>
   */
  var $time_offset = 0;
  
  /**
   * <p>How to display the dates in the pfchat.
   * (Default value: <code>'d/m/Y'</code>)</p>
   */
  var $date_format = 'd/m/Y';

  /**
   * <p>How to display the time in the pfchat
   * (Default value: <code>'H:i:s'</code>)</p>
   */
  var $time_format = 'H:i:s';
  
  /**
   * <p>This parameter is useful when your pfchat server is behind a reverse proxy that
  ...
  /**
   * <p>Most of the pfchat parameters are stored in a internal cache for performances issues.
   * It means that for all the clients the pfchat will have the same parameters. However sometime you need
  ...
  var $smileys             = array();
  var $errors              = array();
  var $is_init             = false; // used internaly to know if the pfchat config is initialized
  ...
  function init()
  {
    ...
    if ($this->title == "")           $this->title        = _pfc("My pfchat");

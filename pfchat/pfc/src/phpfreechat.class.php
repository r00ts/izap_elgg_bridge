...
class phpFreeChat
{
   ...
   * it inserts necessary html which will receive pfchat's data
   * usage:
   * <code>
  ...
  function printChat( $return = false )
  {
    ...
    {    
      ...
      $path = $c->getFilePathFromTheme('pfchat.js.tpl.php');
  ...
  function &loadScripts($theme, &$xml_reponse)
  {
    ...
    $labels_to_load =
      array( "Do you really want to leave this room ?", // _pfc
             ...
             "Mail", // _pfc
             "Color", // _pfc
             "PHP FREE pfchat [powered by phpFreeChat-%s]", // _pfc
             ...
             "Maximum number of private pfchat has been reached", // _pfc
...
';
  ...
  function loadInterface($theme = 'default', &$xml_reponse)
  {
    ...
    $path = $c->getFilePathFromTheme('pfchat.html.tpl.php');
    $t = new pfcTemplate($path);
    $t->assignObject($u,"u");
    $t->assignObject($c,"c");
    $html .= $t->getOutput();

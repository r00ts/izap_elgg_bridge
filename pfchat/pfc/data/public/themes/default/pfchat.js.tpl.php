...
<div style="width:250px;background-color:#FFF;border:1px solid #000;padding:10px;position:relative;margin:auto">
  <p style="padding:0;margin:0;text-align:center;">
    <?php echo _pfc("pfchat loading ..."); ?><br style="margin:0"/><?php echo _pfc("Please wait"); ?>
  </p>
</div>
...
function trace(text) {
  ...
  proto('pfc_debug').innerHTML = '<p style="margin:0;border-bottom:1px solid #555;background-color:'+color+'">' + text + '</p>' + proto('pfc_debug').innerHTML ;
}
<?php } ?>
...
<hr />
Please ask the <a href="http://www.phpfreechat.net">phpfreechat</a> community on the <a href="http://www.phpfreechat.net/forum/">forum</a> if you are not able to load the pfchat.
</p>
</noscript>
<script type="text/javascript">
  // <![CDATA[
...
{
  proto('pfc_notloading').style.display = 'none';
  pfc_isready = true;
}
  // ]]>
</script>
...
<div id="pfc_container"><!-- Will contains pfchat.html.tpl.php --></div>

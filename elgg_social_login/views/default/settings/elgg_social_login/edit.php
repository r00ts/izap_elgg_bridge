...
<p style="font-size: 14px;"> 
	...
	<br />
	<br />
	To know more about it, please run the plugin requirements test and if you need further assistance, feel free to contact me at <b>hybridauth@gmail.com</b>

	<br />
	<br />
	<br />
	<div align="center">
	<b><a href="<?php echo $plugin_base_url ?>diagnostics.php?url=http://www.example.com" target="_blank"  style="background-color:#FFFFFF; border: 1px solid #CCCCCC;border-radius: 5px;padding: 5px;text-decoration: none;"> Run the plugin requirements test </a></b>
	&nbsp;
	<b><a href="<?php echo $plugin_base_url ?>help/index.html#settings" target="_blank"  style="background-color:#FFFFFF; border: 1px solid #CCCCCC;border-radius: 5px;padding: 5px;text-decoration: none;"> Read the plugin user guide </a></b>
	<br /><br /><br />
	</div>
</p>
<?php
...
?> 
	<p style="font-size: 14px;margin-left:10px;"> 
		...
		<br />
		<div align="center">
		<b><a href="<?php echo $plugin_base_url ?>diagnostics.php?url=http://www.example.com" target="_blank"  style="background-color:#FFFFFF; border: 1px solid #CCCCCC;border-radius: 5px;padding: 7px;text-decoration: none;"> Run the plugin requirements test </a></b>
		&nbsp;
		<b><a href="<?php echo $plugin_base_url ?>help/index.html#settings" target="_blank"  style="background-color:#FFFFFF; border: 1px solid #CCCCCC;border-radius: 5px;padding: 7px;text-decoration: none;"> Read the plugin user guide </a></b>
		</div>
		<br /> 
	</p>
...
<?php   
	...
	?> 
	<div> 
		<div style=" border-radius:3px; border: 1px solid #999999;background-color:#FFFFFF;">
			<div style="padding: 5px;margin: 5px;background: none repeat scroll 0 0 #F5F5F5;border-radius:3px;">
